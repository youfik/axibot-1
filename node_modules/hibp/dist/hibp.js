(function (global, factory) {
  ...
  var fetchFromApi = (function (endpoint) {
    return Promise.resolve(axios$2.get(endpoint)).then(function (res) {
      return res.data;
    }).catch(function (err) {
      if (err.response) {
  ...
  var breach = function breach(breachName) {
    return fetchFromApi("/breach/" + encodeURIComponent(breachName));
  };
  ...
  var breachedAccount = function breachedAccount(account, options) {
    if (options === void 0) {
      options = {};
    }
  ...
  var breaches = function breaches(options) {
    if (options === void 0) {
      options = {};
    }
  ...
  var dataClasses = function dataClasses() {
    return fetchFromApi('/dataclasses');
  };
  ...
  var fetchFromApi$1 = (function (endpoint) {
    return Promise.resolve(axios$3.get(endpoint)).then(function (res) {
      return res.data;
    }).catch(function (err) {
      if (err.response) {
        switch (err.response.status) {
  ...
  var pwnedPasswordRange = function pwnedPasswordRange(prefix) {
    return fetchFromApi$1("/range/" + encodeURIComponent(prefix)) // create array from lines of text in response body
    .then(function (data) {
      return data.split('\n');
  ...
  var search = function search(account, breachOptions) {
    ...
    /^.+@.+$/.test(account) ? pasteAccount(account) : null]).then(function (_ref) {
      var breaches = _ref[0],
          pastes = _ref[1];
      return {
        breaches: breaches,
