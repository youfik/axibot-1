...
var _fetchFromApi = _interopRequireDefault(require("./internal/pwnedpasswords/fetchFromApi"));
...
var pwnedPasswordRange = function pwnedPasswordRange(prefix) {
  return (0, _fetchFromApi.default)("/range/" + encodeURIComponent(prefix)) // create array from lines of text in response body
  .then(function (data) {
    return data.split('\n');
...
var _default = pwnedPasswordRange;
